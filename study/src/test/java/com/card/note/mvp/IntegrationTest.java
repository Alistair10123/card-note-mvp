...
import com.card.note.mvp.CardNoteApp;
import com.card.note.mvp.config.AsyncSyncConfiguration;
import com.card.note.mvp.config.EmbeddedSQL;
...
@SpringBootTest(classes = { CardNoteApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
