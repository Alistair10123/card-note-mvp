...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.card.note.mvp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.card.note.mvp.security.DomainUserDetailsService", "createSpringSecurityUser");
