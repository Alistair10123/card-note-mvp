...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.link.note.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.link.note.security.DomainUserDetailsService", "createSpringSecurityUser");
